$(document).ready(function () {
    $('#submit').click(function (event) {
       ...
       ajaxdelete(); //pour chaque click sur le bouton on execute la fonction ajaxdelete() declarer ci dessous
    });
...

    {
        ...
        */
        ...
        $.post("ajax3.php", parameters,function(data){$('#employes').html(data.resultat);
